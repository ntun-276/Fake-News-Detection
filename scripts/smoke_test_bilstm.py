...
def run_smoke_test() -> None:
    output_dir = PROJECT_ROOT / "artifacts" / "bilstm_phase2_smoke"
    smoke_data_dir = PROJECT_ROOT / "artifacts" / "tmp_bilstm_smoke_data"
    ...
    assert model_path.name == "bilstm_phase2.pt", "Unexpected model filename for phase-2"
    assert result["sequence_mode"] == "input_ids", "BiLSTM is not running in input_ids mode"

    print("BiLSTM phase-2 smoke test passed")
