...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train phase-1 LSTM baseline for fake news detection.")
    ...
    parser.add_argument("--output-dir", default="artifacts/lstm_phase1")
...
def main() -> None:
    ...
    if result["sequence_mode"] != "input_ids":
        raise RuntimeError("LSTM must run with input_ids mode")
